...
contract Friendship is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Friendship.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(Friendship.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Friendship.ownerOf(tokenId), to, tokenId);
    }
